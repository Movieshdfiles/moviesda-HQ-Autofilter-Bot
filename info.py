...
# ============================
SESSION = environ.get('SESSION', 'Moviesdaxbotz_search')   # Session name for the bot
API_ID = int(environ.get('API_ID', '21757905')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '5631e91f55477ccbe38e373643dd11ae')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8524551620:AAEZRej9-_1Z3fW7j2jzj9PUq2OF13_8F8I")    # Bot token from @BotFather
...
PICS_URL = (environ.get('PICS', 'https://files.catbox.moe/dxe65o.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002604599918'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002352102532').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '7688635133')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002420751159')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Moviesdalink_ADMIN_Bot')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1001721037051")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1001721037051")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sridhar:JCe6Im9ewEgisgZJ@cluster0.zxsjlpz.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Moviesdahqfiles') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002372759576'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002613678945')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002358578500')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/how_to_download_moviesda/79")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/how_to_download_moviesda/79")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_download_moviesda/79")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "da518857c4f049067c737dff4c770e1d05cc3e20") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "babylinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "da518857c4f049067c737dff4c770e1d05cc3e20")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "babylinks.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "da518857c4f049067c737dff4c770e1d05cc3e20")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "babylinks.in") # Shortener website for third website
...
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '2057229350').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '2057229350').split()]
